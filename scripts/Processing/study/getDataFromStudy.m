...
%% do DipClust
    ...
    if do_plot_clustmetrics
        ...
        mkdir(fullfile('D:\shared_git\MaestriaThesis\results',...
        type_of_pp,'eeglabStudy','MatlabDipPlots'))
...
%% Save
    ...
    if savemat
        mkdir(fullfile('D:\shared_git\MaestriaThesis\results',...
        type_of_pp,'eeglabStudy','MatlabDS'))
    ...
    if savejpg
        mkdir(fullfile('D:\shared_git\MaestriaThesis\results',...
        type_of_pp,'eeglabStudy','PlotERP'))

        save ERP
        figure(fignum+10)   

        ts = -1000:1/250*1000:3999;
